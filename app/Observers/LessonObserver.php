...
//cuando crear o actualiza un Lesson corre las funciones
class LessonObserver
{
    ...
    //si eliminan un lesson
    public function deleting(Lesson $lesson){
        //verifica si existe un resource(es una imagen, la tbl tiene una relación polimorfica)
        if($lesson->resource){
